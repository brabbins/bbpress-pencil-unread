...
class bbP_Pencil_Unread {
	...
	function scripts_styles(){
            ...
            //STYLES
						if ( $this->get_options( 'fontawesome' ) == 'off' ) :
	...
	function scripts_styles_admin(){
            ...
            if ( !$this->is_bbppu_admin() ) return;
						...
						wp_register_script( 'bbppu-admin-js', $this->plugin_url . '_inc/js/bbppu-admin.js', array( 'jquery' ) );

            //SCRIPTS
						wp_enqueue_media();
						wp_enqueue_script('bbppu-admin-js');
